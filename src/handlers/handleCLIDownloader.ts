    ...
    public getDownloadList(os: string): Map<string, ToolSpec> {
        ...
        if (os === OSUtil.MACOS_64) {
            ...
            map.set(
                ...
                this.getToolSpec(
                    "https://intellij-plugin-dependencies.s3.us-east-2.amazonaws.com/cbmigrate/cbmigrate_0.3.0_darwin_amd64.zip",
                    this.TOOL_MDB_MIGRATE,
                    OSUtil.MACOS_64
                )
            );
            ...
            map.set(
                this.TOOL_MDB_MIGRATE,
                this.getToolSpec(
                    "https://intellij-plugin-dependencies.s3.us-east-2.amazonaws.com/cbmigrate/cbmigrate_0.3.0_darwin_arm64.zip",
                    this.TOOL_MDB_MIGRATE,
                    OSUtil.MACOS_ARM
                )
            );
            ...
            map.set(
                this.TOOL_MDB_MIGRATE,
                this.getToolSpec(
                    "https://intellij-plugin-dependencies.s3.us-east-2.amazonaws.com/cbmigrate/cbmigrate_0.3.0_windows_amd64.zip",
                    this.TOOL_MDB_MIGRATE,
                    OSUtil.WINDOWS_64
                )
            );
            ...
            map.set(
                this.TOOL_MDB_MIGRATE,
                this.getToolSpec(
                    "https://intellij-plugin-dependencies.s3.us-east-2.amazonaws.com/cbmigrate/cbmigrate_0.3.0_linux_amd64.zip",
                    this.TOOL_MDB_MIGRATE,
                    OSUtil.LINUX_64
                )
            );
            ...
            map.set(
                this.TOOL_MDB_MIGRATE,
                this.getToolSpec(
                    "https://intellij-plugin-dependencies.s3.us-east-2.amazonaws.com/cbmigrate/cbmigrate_0.3.0_linux_arm64.zip",
                    this.TOOL_MDB_MIGRATE,
                    OSUtil.LINUX_ARM
                )
            );
