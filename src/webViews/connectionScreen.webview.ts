        ...
        <div class="container">
            <div class="left-container">
                ...
                <div>
                    ...
                    <input type="text" id="username" name="username" placeholder="Username" value=${message?.username
                        ?? "Administrator" } />
                    ...
                    <input type="text" id="connectionIdentifier" name="identifier" placeHolder="Name of your connection"
                        value=${message?.connectionIdentifier ?? "" }>
                        ...
                        <details>
                            ...
                            <div class="troubleshooting-message">
                                <p>If you can't successfully connect to your cluster, try informing an existing bucket in
                                    ...
                                    <strong>SDK Doctor</strong>, a utility that tries to identify potential issues.
                                </p>
                            </div>
                            <div class="bucket-input">
                                <label for="bucketName">Bucket Name:</label><br>
                                <input type="text" id="bucketName" name="bucketName"
                                    placeholder="Inform any existing bucket in your cluster">
                            </div>
                            <button class="redButton" id="testConnectionButton" onclick="testConnection()">Test
                                Connection</button>
                    ...
                    <div class="button-group">
                        <button id="connectButton" class="redButton"
                            onClick="validateRequest() && postRequestToConnect()">Connect</button>
            ...
            <div class="right-container">
                ...
                <div>
                    <h4>
                        If you don't already have a cluster you can install couchbase locally or create a cluster using
                        capella
                    </h4>
                </div>
