...
export function getClusterConnectingFormView(): string {
   return `
      ...
      <body>
         <form>
            <label for="url">Enter Cluter Connection URL:</label><br>
            <input type="text" id="url" name="url" placeholder="URL" value="couchbase://localhost" required /> <br/><br/>
            <label for="url">Enter Username:</label><br>
            <input type="text" id="username" name="class" placeholder="Username" value="Administrator" required /> <br/><br/>
            <label for="password">Enter Password:</label><br> 
            <input type="password" id="password" name="rollno" placeholder="Password" value="password" required> <br/><br/>
            <label for="connectionIndetifier">Enter Connection Identifier (optional):</label><br>
            <input type="text" id="connectionIdentifier" name="identifier" placeHolder="Connection Identifier" value="" > <br/><br/>
            <input type="button" value="Submit" onclick="postRequestToConnect()"/>
         </form>
         <script>
