...
export const collectionIntentHandler = async (jsonObject: any, response: IAdditionalContext, cacheService: CacheService) => {
    ...
    response.collectionIntent = collectionIntent;
};